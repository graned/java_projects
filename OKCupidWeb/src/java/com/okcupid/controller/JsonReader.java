...
public class JsonReader {
    ...
    /**
     * This method translate a single user profile from a json string and converts it into a UserProfile object
     * @param jsonUserProfile JSON representation of a user profile
     * @return a UserProfile object
     */
    public UserProfile getProfileFromJSON(String jsonUserProfile) {
        UserProfile userProfile;
        Answer answer;
        userProfile = new UserProfile();
        JSONObject jsonProfile = new JSONObject(jsonUserProfile);
    ...
    /**
     * This method translates a JSON string to a UserProfile collection
     *
     * @param jsonString String representation of a JSON data
     * @return An ArrayList of UserProfiles
     */
    public ArrayList<UserProfile> jsonToObject(String jsonString) {
        ...
        for (int i = 0; i < jsonProfiles.length(); i++) {
            ...
            usersList.add(getProfileFromJSON(jsonProfile.toString()));
        }
        return usersList;
    }
